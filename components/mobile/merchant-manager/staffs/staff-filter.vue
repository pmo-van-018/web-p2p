        ...
        <filter-menu :active="activeFilterOptions">
          ...
          >
            <form-content>
              ...
              <template #action>
                ...
                <base-button variants="contained" color="primary" @click="handleSubmitFilterOptions(refName.search)">
          ...
          >
            <form-content>
              ...
              <template #action>
                <base-button variants="outlined" @click="handleResetFilterOptions(refName.status)">
                  {{ $t('role_management.modal.reset') }}
                </base-button>
                <base-button variants="contained" color="primary" @click="handleSubmitFilterOptions(refName.status)">
                  {{ $t('role_management.modal.confirm') }}
                </base-button>
              </template>
            </form-content>
          ...
          >
            <form-content>
              ...
              <template #action>
                <base-button variants="outlined" @click="handleResetFilterOptions(refName.staffRole)">
                  {{ $t('role_management.modal.reset') }}
                </base-button>
                <base-button variants="contained" color="primary" @click="handleSubmitFilterOptions(refName.staffRole)">
                  {{ $t('role_management.modal.confirm') }}
                </base-button>
              </template>
            </form-content>
...
export default {
  ...
  computed: {
    ...
    searchFilter () {
      return this.search || this.$t('role_management.label.wallet_address')
    },
    filterOptions () {
      return {
        search: this.search,
