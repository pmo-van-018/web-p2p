  ...
  <div class="payments">
    <client-only>
      ...
      <div class="payments__btn d-flex justify-content-between align-items-center">
        <span class="payments__label grey-900 font-t16b">{{ $t('user.payments.label.add_payment_mobile') }}</span>
        <span class="icon-add-primary" @click="showModalAddBank" />
      </div>
...
export default {
  ...
  computed: {
    ...mapState('payments', ['publicPayments'])
  },
  mounted () {
