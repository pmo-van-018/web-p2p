  ...
  >
    <div class="modal-content mt-2">
      <div class="text-center">
        <img :src="require('~imageRoot/common/method/delete.svg')" alt="icon delete" width="120" height="120">
      </div>
      <p class="modal-content__txt grey-900 font-t16r mb-0 text-center">{{ getWarningNote() }}</p>
      <base-button
        variants="contained"
        color="primary"
        @click="submit"
