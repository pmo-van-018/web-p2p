...
<script>
import merchantPublicViewSellMixin from '@/mixins/merchant/public-view/sell.js'
import PostItemInfo from '@/components/desktop/list-post/post-item-info.vue';
import PostItemDetailSell from '@/components/desktop/list-post/post-item-detail-sell.vue';
...
export default {
  ...
  mixins: [merchantPublicViewSellMixin],
  async mounted () {
