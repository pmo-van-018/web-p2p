<template>
  <div class="merchant-manager-info">
    <div class="merchant-manager-info__col">
      <div class="merchant-manager-info__item">
        ...
        <span class="merchant-manager-info__value wallet-address">
          <span class="name">{{ merchantManager?.walletAddress }}</span>
...
<style lang="scss" scoped src="../../../../../static/assets/scss/components/desktop/admin/staffs/merchant-manager-info.scss" />
